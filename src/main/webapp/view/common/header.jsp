...
<body>
<header>
<a class="logo" href="/view/board/list.jsp"><span class="material-symbols-outlined">run_circle</span></a>
        <nav>
            <div class="d-flex justify-content-center">
                ...
                <form role="search" action="/board/list">
                    <select class="btn btn-light" name="period" >
                    ...
                    <select class="btn btn-light" name="value">
